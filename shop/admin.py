...
admin.site.register(models.StockDataNormal)
...
admin.site.register(models.StudyStockDataIndicatorNormalValue)
admin.site.register(models.StudyOrder)
admin.site.register(models.StudyOrderNormalValues)
